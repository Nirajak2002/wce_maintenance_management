			...
			async () => {
				try {
					...
					editedData[index] = {
						...
						setMaterialSpec: selectedMaterial.materialSpec.trim(),
	...
	const editModeForm = (index) => {
		return (
			<TableRow key={index}>
				...
				<TableCell component="th" scope="row" width="20%">
					{selectedMaterial.unitMeasure}
				</TableCell>


				<TableCell component="th" scope="row" align="right" width="15%">
					<FormControl>
						<TextField
		...
		return (
			<TableRow key={index}>
				...
				{item.addedBy === currentUserId && (
					<TableCell component="th" scope="row" width="15%" align="center">
						<IconButton
							style={{ padding: '5px' }}
							size="small"
			...
			<Table aria-label="simple table">
				<TableHead>
					<TableRow>
						...
						<TableCell width="15%">Unit of Measurement</TableCell>

						<TableCell width="15%" align={inEditMode.state ? 'left' : 'right'}>
							Cost
						</TableCell>
